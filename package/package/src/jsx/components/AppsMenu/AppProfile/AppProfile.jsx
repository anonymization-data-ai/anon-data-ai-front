		...
		<Fragment>
			...
			<Modal show={state.link} className="modal fade post-input" id="linkModal" onHide={() => dispatch({ type: 'linkModal' })}>
				<div className="modal-content">
					...
					<div className="modal-body">
						<Link className="btn-social me-1 my-1 my-sm-0 facebook" to="/app-profile"><i className="fab fa-facebook-f" /></Link>
						<Link className="btn-social me-1 my-1 my-sm-0 google-plus" to="/app-profile"> <i className="fab fa-google-plus" /></Link>
						<Link className="btn-social me-1 my-1 my-sm-0 linkedin" to="/app-profile"><i className="fab fa-linkedin" /></Link>
						<Link className="btn-social me-1 my-1 my-sm-0 instagram" to="/app-profile"> <i className="fab fa-instagram" /></Link>
						<Link className="btn-social me-1 my-1 my-sm-0 twitter" to="/app-profile"><i className="fab fa-twitter" /></Link>
