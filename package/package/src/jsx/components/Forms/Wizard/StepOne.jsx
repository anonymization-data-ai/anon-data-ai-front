   ...
   return (
      <section>
         <div className="row">
            ...
            <div className="col-lg-6 mb-2">
               <div className="form-group mb-3">
                  <label className="text-label">Phone Number <span className="text-danger">*</span></label>
                  <input
                     type="number"
                     name="phoneNumber"
                     className="form-control"
            ...
            <div className="col-lg-12 mb-3">
               <div className="form-group mb-3">
                  <label className="text-label">Where are you from <span className="text-danger">*</span></label>
                  <input
                     type="text"
                     name="place"
                     className="form-control"
